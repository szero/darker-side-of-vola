...
(function () {
    ...
    GM_addStyle([
        ...
        "        height: 0px; ",
        "    } ",
        "    .icon-play.radio_icon,.icon-play.chat_file_icon ",
        "    .icon-stop.radio_icon, .icon-stop.chat_file_icon ",
        "    .icon-pause.radio_icon { ",
        "        width: 20px; ",
        "        height:20px; ",
        "    } ",
